...
public class IslamicCompactCalendarView extends View {
    ...
    public IslamicCompactCalendarView(Context context) {
        this(context, null);
    }

    public IslamicCompactCalendarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IslamicCompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        compactCalendarController = new CompactCalendarController(new Paint(), new OverScroller(getContext()),
                ...
                Color.argb(255, 100, 68, 65), new EventsContainer(new IslamicCalendar()),
                new ULocale("@calendar=islamic-umalqura"), TimeZone.getDefault());
     ...
     */
    public void setLocale(TimeZone timeZone, ULocale locale) {
