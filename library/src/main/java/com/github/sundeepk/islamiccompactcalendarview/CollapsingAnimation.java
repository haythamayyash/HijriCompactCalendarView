...
class CollapsingAnimation extends Animation {
    ...
    private final IslamicCompactCalendarView view;
    private int targetGrowRadius;
    private final boolean down;
    private CompactCalendarController compactCalendarController;

    public CollapsingAnimation(IslamicCompactCalendarView view, CompactCalendarController compactCalendarController, int targetHeight, int targetGrowRadius, boolean down) {
        this.view = view;
