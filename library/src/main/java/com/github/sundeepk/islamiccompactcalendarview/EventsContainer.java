...
import com.github.sundeepk.islamiccompactcalendarview.comparators.EventComparator;
...
public class EventsContainer {
    ...
    public EventsContainer(IslamicCalendar eventsCalendar) {
    ...
    private Events getEventDayEvent(long eventTimeInMillis){
        eventsCalendar.setTimeInMillis(eventTimeInMillis);
        int dayInMonth = eventsCalendar.get(IslamicCalendar.DAY_OF_MONTH);
        String keyForCalendarEvent = getKeyForCalendarEvent(eventsCalendar);
        ...
        if (eventsForMonthsAndYear != null) {
            for (Events events : eventsForMonthsAndYear) {
                ...
                int dayInMonthFromCache = eventsCalendar.get(IslamicCalendar.DAY_OF_MONTH);
    ...
    private String getKeyForCalendarEvent(IslamicCalendar cal) {
        return cal.get(IslamicCalendar.YEAR) + "_" + cal.get(IslamicCalendar.MONTH);
    }
