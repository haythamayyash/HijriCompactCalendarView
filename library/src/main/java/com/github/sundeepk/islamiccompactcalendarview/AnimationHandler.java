...
class AnimationHandler {
    ...
    private IslamicCompactCalendarView.CompactCalendarAnimationListener compactCalendarAnimationListener;

    AnimationHandler(CompactCalendarController compactCalendarController, IslamicCompactCalendarView islamicCompactCalendarView) {
        this.compactCalendarController = compactCalendarController;
        this.islamicCompactCalendarView = islamicCompactCalendarView;
    }

    void setCompactCalendarAnimationListener(IslamicCompactCalendarView.CompactCalendarAnimationListener compactCalendarAnimationListener){
    ...
    void openCalendar() {
        ...
        islamicCompactCalendarView.getLayoutParams().height = 0;
        islamicCompactCalendarView.requestLayout();
        islamicCompactCalendarView.startAnimation(heightAnim);
    }
    ...
    void closeCalendar() {
        ...
        compactCalendarController.setAnimationStatus(CompactCalendarController.EXPAND_COLLAPSE_CALENDAR);
        islamicCompactCalendarView.getLayoutParams().height = islamicCompactCalendarView.getHeight();
        islamicCompactCalendarView.requestLayout();
        islamicCompactCalendarView.startAnimation(heightAnim);
    }
    ...
    private Animation getCollapsingAnimation(boolean isCollapsing) {
        return new CollapsingAnimation(islamicCompactCalendarView, compactCalendarController, compactCalendarController.getTargetHeight(), getTargetGrowRadius(), isCollapsing);
    }
